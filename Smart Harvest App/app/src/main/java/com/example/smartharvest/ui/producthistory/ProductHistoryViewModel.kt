...
class ProductHistoryViewModel(private val repository: Repository) : ViewModel() {
    ...
    fun getProductHistoryProducer(id : String) {
        ...
        val productItemResponses = apiService.getProductHistoryProducer(id)
    ...
    fun getProductHistoryDistributor(id : String) {
        _isLoading.value = true
        val apiService = ApiConfig().getApiService()
        val productItemResponses = apiService.getProductHistoryDistributor(id)
    ...
    fun getProductHistorySeller(id : String) {
        _isLoading.value = true
        val apiService = ApiConfig().getApiService()
        val productItemResponses = apiService.getProductHistorySeller(id)
